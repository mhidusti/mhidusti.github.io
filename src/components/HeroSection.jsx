            ...
            <div className="col-12">
              <div className="hero-wrrapper wow fadeInUp" data-wow-delay=".4s">
                <div className="hero-image-box d-none d-md-inline-block">
                  <img src="/assets/img/hero/hero-2.png" alt="Hero background" />
                </div>

                <div className="hero-content-box">
                  <h1 className="hero-title">
                    سلام، من سام هستم - وب <br /> توسعه دهنده + طراح UX
                  </h1>

                  <div className="hero-image-box d-md-none text-center">
                    <img src="/assets/img/hero/me.png" alt="Sam portrait" />
                  </div>

                  <p className="lead">
                    من چیزهای ساده و زیبا را طراحی و کدنویسی می‌کنم و کاری را که انجام می‌دهم دوست دارم.
                  </p>
                  ...
                  <div className="button-box d-flex flex-wrap align-items-center">
                    ...
                    <ul className="ul-reset social-icons style-2">
                      <li><a href="#"><i className="fa-brands fa-twitter" aria-hidden="true"></i></a></li>
                      <li><a href="#"><i className="fa-light fa-basketball" aria-hidden="true"></i></a></li>
                      <li><a href="#"><i className="fa-brands fa-linkedin-in" aria-hidden="true"></i></a></li>
                      <li><a href="#"><i className="fa-brands fa-github" aria-hidden="true"></i></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="funfact-area style-2">
                ...
                <div className="funfact-item wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <div className="number"><span className="odometer" data-count="14">0</span>+</div>
                  <div className="text">پروژه‌های اتمام شده</div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-lg-7">
                    <div className="about-left-content wow fadeInUp" data-wow-delay=".3s">
                      ...
                      <div className="desc">
                        <p className="lead">لورم ایپسوم متن ساختگی ...</p>
                      </div>
                      <div className="about-button d-flex">
                        <a href="#" className="btn tj-btn-primary-2">
                          تماس با من
                          <span className="icon_box" aria-hidden="true">
                            <i className="fa-regular fa-arrow-right icon_first"></i>
                            <i className="fa-regular fa-arrow-right icon_second"></i>
                  ...
                  <div className="col-lg-5">
                    <div className="about-right-content wow fadeInUp" data-wow-delay=".5s">
                      <div className="about-text">
                        ...
                        <div className="desc"><p>لورم ایپسوم ...</p></div>
                      </div>
                      <div className="about-images">
                        <img src="/assets/img/hero/about-1.png" alt="About image" />
                      </div>
                    </div>
                  </div>
                </div>
